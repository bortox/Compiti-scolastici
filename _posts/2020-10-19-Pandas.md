...
modified: 2020-10-19T23:52:33+02:00
---
...
Creiamo un nuovo dataframe ( sostanzialmente, una tabella ) dalla tabella numero `i` ( specificato nel loop `for i in range(7):` ) del file html precedentemente importato.
